"""AI service for chat responses using Groq API."""
import os
import time
import logging
...
class AIService:
    ...
    def _is_rate_limit(self, error: Exception) -> bool:
        ...
        err = str(error).lower()
        return ("429" in str(error) or "rate" in err or "too many" in err 
                or "quota" in err or "tokens per day" in err)
...
def get_trade_signal(
    ...
    """Get AI trade signal for user message."""
